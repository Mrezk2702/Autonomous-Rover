...
#define TIMER1_WAVE_FORM_CHANNELC          COCSOT
...
#define TIMER3_MODE                        FAST_PWM_8BIT
#define TIMER3_CHANNELA                    ENABLE
#define TIMER3_CHANNELB                    DISABLE
#define TIMER3_CHANNELC                    DISABLE
#define TIMER3_WAVE_FORM_CHANNELA          COCSOT
#define TIMER3_WAVE_FORM_CHANNELB          COCSOT
#define TIMER3_WAVE_FORM_CHANNELC          COCSOT
